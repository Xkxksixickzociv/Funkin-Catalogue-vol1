...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	CoderName1 = 'RamenDominoes'
	CoderName2 = 'Mura'
	CoderName3 = ''

	ArtistName1 = 'MathewPurpleToons'
	ArtistName2 = 'DyanEstella'
	ArtistName3 = 'PhantomArcade'
...
CreditsExitTimer = 2 --How many seconds the script will show before exiting

TweenSpeed = 1 --How fast the credits move in/out
